...
#SBATCH --output=/users/j/n/jnzapata/projects/eco_genomics_2025/population_genomics/mylogs/%x_%j.out
...
#This script will use ANGSd to estimate Fst beteween my red spruce pop
#and black spruce from outside

REPO="/users/j/n/jnzapata/projects/eco_genomics_2025/population_genomics/"
