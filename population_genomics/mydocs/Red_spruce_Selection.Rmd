...
Test for correlation between Amidxture scores from the red-black spruce analysis and the PC1 scores from the red spruce only analysis Is PC1 still an axis of introgression? ... #complete..
...
Now read in our selection stats and calculate the p values based on the Chi Square distribution !!!You'll need to edit the value you used for K here!!!
...
Now make a Mahayyan plot for PC1 and PC2 separately
