...
.libPaths(c("/gpfs1/cl/ecogen/sw/R/4.5", .libPaths()))
library(DESeq2, lib="/gpfs1/cl/ecogen/sw/R/4.5")
library(dplyr)
library(tidyr)
library(ggplot2)
library(scales, lib="/gpfs1/cl/ecogen/sw/R/4.5")
library(ggpubr)
...
#Corrects the column names to match between the meradata table and the counts matrix
