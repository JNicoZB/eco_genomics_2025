...
#SBATCH --output=/users/j/n/jnzapata/projects/eco_genomics_2025/Transcriptomics/mylogs/%x_%j.out
...
MYREPO="/users/j/n/jnzapata/projects/eco_genomics_2025"
...
NAME1=$(echo $READ1 | sed "s/_R1/_R1_cleanNZ/g")
NAME2=$(echo $READ2 | sed "s/_R2/_R2_cleanNZ/g")
